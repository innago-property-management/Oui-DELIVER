...
If improvements were found, format as PR comment:
...
### Phase 5: Post Comment (or Exit)
- **If improvements found:** Post the formatted comment on the PR
- **If NO improvements found:** Exit silently without posting (silence is success!)
